...
import vn.edu.tdc.ltdd2.adapters.BadSellProductAdapter;
import vn.edu.tdc.ltdd2.adapters.BestSellProductAdapter;
...
public class RevenueStatisticActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private TextView txtTotalSuccess, txtSuccessOrder, txtTotalCanceled, txtCanceledOrder, txtInventory, txtTotalOrder, txtCountOrder, txtCountInventory, txtRole, txtName, btnBack;
    ...
    private void setEvent() {
        ...
        btnBack.setOnClickListener(v -> {
            intent = new Intent(RevenueStatisticActivity.this, MainADMActivity.class);
    ...
    private void UIinit() {
        ...
        subtitleAppbar.setText(R.string.titleTKDT);
        btnBack = toolbar.findViewById(R.id.txtBack);
