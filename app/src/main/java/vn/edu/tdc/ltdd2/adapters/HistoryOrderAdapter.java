...
import vn.edu.tdc.ltdd2.activitys.DetailOrderActivity;
...
public class HistoryOrderAdapter extends RecyclerView.Adapter<HistoryOrderAdapter.HistoryOrderViewHolder>{
    ...
    public void onBindViewHolder(@NonNull HistoryOrderViewHolder holder, int position) {
        ...
        holder.imgCardHistoryOrder.setImageResource(R.drawable.catagory);

        holder.CardHistoryOrder.setOnClickListener((View.OnClickListener) view -> {
