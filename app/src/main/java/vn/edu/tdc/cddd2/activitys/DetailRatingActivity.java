...
public class DetailRatingActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void pushNotification(String comment, String accountID) {
        ...
        if (!comment.equals("")) {
            ...
            FirebaseStorage.getInstance().getReference("images/comments").putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    FirebaseStorage.getInstance().getReference("images/comments").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        @Override
