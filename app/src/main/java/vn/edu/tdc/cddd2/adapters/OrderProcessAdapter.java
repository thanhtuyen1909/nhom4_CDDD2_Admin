...
public class OrderProcessAdapter extends RecyclerView.Adapter<OrderProcessAdapter.HistoryOrderViewHolder>{
    Context mContext;
    ArrayList<Order> listOrder;

    public OrderProcessAdapter(Context mContext, ArrayList<Order> listOrder) {
