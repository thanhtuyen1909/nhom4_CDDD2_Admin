...
public class AttendanceActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    EditText edtDiemDanh, spinerDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Xá»­ lÃ½ sá»± kiá»‡n click button "Trá»Ÿ láº¡i":
    ...
    private void showSuccesDialog( Attendance item) {
        ...
        View view = LayoutInflater.from(AttendanceActivity.this).inflate(
                R.layout.layout_attendance_dialog,
                findViewById(R.id.layoutDialogAttendance)
        );
        builder.setView(view);
        title = view.findViewById(R.id.textTitle);
        title.setText("Lý do vắng");
        edtDiemDanh = view.findViewById(R.id.edtDiemDanh);
        ...
        view.findViewById(R.id.buttonAction).setOnClickListener(v -> {
            ...
            map.put("note", edtDiemDanh.getText().toString());
            map.put("status", -1);
